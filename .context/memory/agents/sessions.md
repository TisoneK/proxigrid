...
- **Commits:** 6 (docs(research) spec; feat(research) backtester+metrics; chore(context) log; then per user follow-up: fix(deps) deepmerge-ts override; docs(agents) CLAUDE.md; + this chore(context) update).
